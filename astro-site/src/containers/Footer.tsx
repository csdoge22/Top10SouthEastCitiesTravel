    ...
    return (
        <div className="container-sm bg-white">
            ...
            <ul className="list-group list-group-horizontal text-center d-flex offset-3">
                <li className="list-group-item border-black border-5 m-4"><a className="badge bg-warning text-black" href="https://www.instagram.com/csdoge22/">Instagram</a></li>
                ...
                <li className="list-group-item border-black border-5 m-4"><a className="badge bg-info text-black" href="https://www.instagram.com/csdoge22/">LinkedIn</a></li>
            </ul>
        </div>
    )
}
